...
static LIMIT_SPEED: AtomicUsize = AtomicUsize::new(1024 * 1024 * 1024 * 1024); // 1TB/s
static TOTAL_BANDWIDTH: AtomicUsize = AtomicUsize::new(1024 * 1024 * 1024 * 1024); // 1TB/s
static SINGLE_BANDWIDTH: AtomicUsize = AtomicUsize::new(1024 * 1024 * 1024 * 1024); // 1TB/s
